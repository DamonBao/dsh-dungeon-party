    ...
    const disposers = [
        ctx.tools.register(defineDungeonTool({
            ...
            async execute(args, exec) {
                ...
                const workspaceFingerprint = await workspaceComputationQueue.fingerprint(args.workspaceRoot, service.getFingerprintIgnoreScopes());
        ...
        ctx.tools.register(defineDungeonTool({
            ...
            async execute(args, exec) {
                ...
                if (result.timedOut)
                    return canonical({ code: 'VERIFICATION_TIMEOUT', command: args.command, durationMs: result.durationMs, outputExcerpt: result.outputExcerpt });
