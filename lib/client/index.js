...
@keyframes dp-working{0%,100%{box-shadow:0 0 7px color-mix(in srgb,var(--class) 25%,transparent)}50%{box-shadow:0 0 18px color-mix(in srgb,var(--class) 72%,transparent)}}
		...
		children: [
			...
			report ? /* @__PURE__ */ jsxs("article", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("span", {
								...
								children: report.createdAt ?? "时间未知"
							})
						]
					}),
					/* @__PURE__ */ jsx("div", {
					...
					report.summary ? /* @__PURE__ */ jsx("p", {
						className: "dp-report-summary",
						children: report.summary
					}) : null,
					/* @__PURE__ */ jsx("div", {
						className: "dp-check-row",
						children: checkStatusOrder.map((status) => /* @__PURE__ */ jsx("span", {
							className: "dp-check",
							"data-check": status,
							children: `${checkStatusName[status]} ${counts[status]}`
						}, status))
					}),
					groups.length > 0 ? groups.map((group) => /* @__PURE__ */ jsxs("div", {
						...
						}), group.findings.map((finding, index) => /* @__PURE__ */ jsxs("div", {
					...
					}, group.severity)) : /* @__PURE__ */ jsx("div", {
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx("strong", { children: dpsCharges }), /* @__PURE__ */ jsx("span", { children: "DPS 战复剩余" })]
				}), /* @__PURE__ */ jsxs("div", {
					className: "dp-metric",
					"aria-label": `领队战复剩余 ${commanderCharges}`,
					children: [/* @__PURE__ */ jsx("strong", { children: commanderCharges }), /* @__PURE__ */ jsx("span", { children: "领队战复剩余" })]
				})]
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "dp-res-subhead",
				children: [/* @__PURE__ */ jsx("span", { children: "复活申请" }), /* @__PURE__ */ jsx("span", {
					className: "dp-res-meta",
					children: `${activeRequests.length}/${requests.length} 进行中`
				})]
			}),
			activeRequests.length > 0 ? activeRequests.map((request, index) => /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("div", {
						...
						children: `申请于 ${request.requestedAt ?? "—"} · 过期于 ${request.expiresAt ?? "—"}`
					})
				]
			}, request.resurrectionId ?? `request-${index}`)) : /* @__PURE__ */ jsx("div", {
				className: "dp-res-empty",
				children: "暂无进行中的复活申请"
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "dp-res-subhead",
				children: [/* @__PURE__ */ jsx("span", { children: "紧急票据" }), /* @__PURE__ */ jsx("span", {
					className: "dp-res-meta",
					children: `${activeTickets.length}/${tickets.length} 进行中`
				})]
			}),
			activeTickets.length > 0 ? activeTickets.map((ticket, index) => /* @__PURE__ */ jsxs("div", {
				className: "dp-res-item",
				children: [
					/* @__PURE__ */ jsxs("div", {
						className: "dp-res-main",
					...
					/* @__PURE__ */ jsx("div", {
						className: "dp-res-meta-line",
						children: `签发于 ${ticket.issuedAt ?? "—"} · 过期于 ${ticket.expiresAt ?? "—"}`
					})
				]
			}, ticket.ticketId ?? `ticket-${index}`)) : /* @__PURE__ */ jsx("div", {
				className: "dp-res-empty",
				children: "暂无进行中的紧急票据"
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "dp-res-subhead",
				children: [/* @__PURE__ */ jsx("span", { children: "槽位代数" }), /* @__PURE__ */ jsx("span", {
					className: "dp-res-meta",
...
function TaskRow({ task }) {
	...
	return /* @__PURE__ */ jsxs("article", {
		...
		children: [
			...
			dependencies.length > 0 ? /* @__PURE__ */ jsx("div", {
				className: "dp-deps",
				children: dependencies.map((dependency) => /* @__PURE__ */ jsxs("span", {
					className: "dp-dep",
					children: ["↳ ", dependency]
				}, dependency))
			}) : null
...
function DungeonPartyOverlay({ useSessions, requestAction }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!open ? /* @__PURE__ */ jsxs("button", {
			type: "button",
			...
			children: [
				...
				/* @__PURE__ */ jsxs("header", {
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsx("span", { children: phaseName[run.phase] ?? run.phase }), /* @__PURE__ */ jsxs("span", { children: [
								accepted,
								"/",
								tasks.length,
								" 首领目标"
				...
				/* @__PURE__ */ jsx("nav", {
					...
					].map(([id, label, ariaLabel]) => /* @__PURE__ */ jsx("button", {
						type: "button",
						className: "dp-tab",
						"data-active": tab === id,
				...
				/* @__PURE__ */ jsxs("div", {
					...
					"data-tab": tab,
					children: [
						tab === "party" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
							className: "dp-section-head",
							children: [/* @__PURE__ */ jsx("span", {
								className: "dp-section-title",
								children: "团队框架"
						...
						tab === "quests" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
							className: "dp-section-head",
							children: [/* @__PURE__ */ jsx("span", {
								className: "dp-section-title",
								children: "地下城任务日志"
						...
						}), tasks.length > 0 ? /* @__PURE__ */ jsx("div", {
							className: "dp-quest-list",
							children: tasks.map((task) => /* @__PURE__ */ jsx(TaskRow, { task }, task.workOrder.id))
						}) : /* @__PURE__ */ jsxs("div", {
							className: "dp-empty",
							children: [/* @__PURE__ */ jsx("span", {
								className: "dp-empty-glyph",
						...
						tab === "chronicle" ? /* @__PURE__ */ jsxs(Fragment, { children: [
							/* @__PURE__ */ jsxs("div", {
								className: "dp-metrics",
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "dp-metric",
										children: [/* @__PURE__ */ jsx("strong", { children: run.validationReports.length }), /* @__PURE__ */ jsx("span", { children: "验收报告" })]
									}),
									/* @__PURE__ */ jsxs("div", {
										className: "dp-metric",
										children: [/* @__PURE__ */ jsx("strong", { children: run.battleResChargesRemaining }), /* @__PURE__ */ jsx("span", { children: "战斗复活" })]
									}),
									/* @__PURE__ */ jsxs("div", {
										className: "dp-metric",
										children: [/* @__PURE__ */ jsx("strong", { children: run.commanderBattleResChargesRemaining }), /* @__PURE__ */ jsx("span", { children: "领队复活" })]
									})
								]
							}),
							/* @__PURE__ */ jsxs("div", {
						...
						tab === "validation" ? /* @__PURE__ */ jsx(ValidationTab, { run }) : null,
						tab === "actions" ? /* @__PURE__ */ jsxs(Fragment, { children: [
							/* @__PURE__ */ jsxs("div", {
								className: "dp-section-head",
								children: [/* @__PURE__ */ jsx("span", {
									className: "dp-section-title",
								...
								children: [
									/* @__PURE__ */ jsxs("button", {
										...
										children: [
											"⌛ 请求停滞检查",
											/* @__PURE__ */ jsx("br", {}),
											/* @__PURE__ */ jsx("small", { children: "检查失去响应的输出成员与任务租约" })
										]
									}),
									/* @__PURE__ */ jsxs("button", {
										type: "button",
										...
										children: [
											"✚ 指示奶自我稳定",
											/* @__PURE__ */ jsx("br", {}),
											/* @__PURE__ */ jsx("small", { children: "恢复圣谕者的独立验收能力" })
										]
									}),
									/* @__PURE__ */ jsxs("button", {
										type: "button",
										...
										children: [
											"♜ 处理指挥承压",
											/* @__PURE__ */ jsx("br", {}),
											/* @__PURE__ */ jsx("small", { children: "暂停派遣并清理关键决策队列" })
										]
									}),
									/* @__PURE__ */ jsxs("button", {
										type: "button",
										...
										children: [
											"↻ 继续当前副本",
											/* @__PURE__ */ jsx("br", {}),
											/* @__PURE__ */ jsx("small", { children: "断线或团灭后从持久进度恢复" })
										]
									}),
									/* @__PURE__ */ jsxs("button", {
										type: "button",
										...
										children: [
											"⚑ 重开副本",
											/* @__PURE__ */ jsx("br", {}),
											/* @__PURE__ */ jsx("small", { children: "终止本次进度并创建新的队伍" })
										]
									})
								]
							}),
							pendingInstruction ? /* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsx("strong", { children: "施放团队技能？" }),
							...
							/* @__PURE__ */ jsxs("details", {
								className: "dp-raw",
								children: [/* @__PURE__ */ jsx("summary", { children: "开发者模式 · 原始事件投影" }), /* @__PURE__ */ jsx("pre", { children: JSON.stringify(run, null, 2) })]
							})
						] }) : null
					]
				})
...
//#endregion
export { DungeonPartyOverlay, apply, inject, memberMeters, validationCheckCounts, validationFindingGroups };