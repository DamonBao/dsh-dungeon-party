...
var OverlayErrorBoundary = class extends Component {
	state = { error: void 0 };
	...
	render() {
		...
		return /* @__PURE__ */ jsxs("div", {
			...
			"aria-label": "副本面板渲染失败",
			children: [
				/* @__PURE__ */ jsx("strong", { children: "副本面板渲染失败" }),
				/* @__PURE__ */ jsx("span", { children: "投影数据异常或面板组件出错，副本本身的持久状态不受影响。" }),
...
function DungeonPartyOverlay({ useSessions, requestAction }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [!open ? /* @__PURE__ */ jsxs("button", {
		...
		}) : null, open ? /* @__PURE__ */ jsx(OverlayErrorBoundary, { children: /* @__PURE__ */ jsxs("aside", {
			className: "dp-panel",
			role: "dialog",
			"aria-label": "永夜秘境副本状态",
			...
			children: [
				...
				/* @__PURE__ */ jsx("nav", {
					...
					children: tabOrder.map(({ id, label, ariaLabel }) => /* @__PURE__ */ jsx("button", {
						type: "button",
						className: "dp-tab",
						role: "tab",
						id: `dp-tab-${id}`,
				...
				/* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						tab === "quests" ? /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsxs("div", {
							...
							children: tasks.map((task, index) => /* @__PURE__ */ jsx(TaskRow, { task }, task.workOrder?.id ?? `task-${index}`))
						}) : /* @__PURE__ */ jsxs("div", {
							className: "dp-empty",
							children: [/* @__PURE__ */ jsx("span", {
								className: "dp-empty-glyph",
						...
						tab === "chronicle" ? /* @__PURE__ */ jsxs(Fragment, { children: [
							/* @__PURE__ */ jsxs("div", {
								...
								children: [
									/* @__PURE__ */ jsxs("div", {
										className: "dp-metric",
										children: [/* @__PURE__ */ jsx("strong", { children: Array.isArray(run.validationReports) ? run.validationReports.length : 0 }), /* @__PURE__ */ jsx("span", { children: "验收报告" })]
									}),
									/* @__PURE__ */ jsxs("div", {
										className: "dp-metric",
							...
							messages.length > 0 ? /* @__PURE__ */ jsx("div", {
								...
								children: messages.map((message, index) => /* @__PURE__ */ jsxs("div", {
									className: "dp-event",
									children: [
						...
						tab === "actions" ? /* @__PURE__ */ jsxs(Fragment, { children: [
							...
							/* @__PURE__ */ jsx("div", {
								...
								children: partyActions.map((action) => /* @__PURE__ */ jsxs("button", {
									type: "button",
									className: "dp-button",
									...
									children: [
										action.label,
										/* @__PURE__ */ jsx("br", {}),
										/* @__PURE__ */ jsx("small", { children: action.caption })
									]
								}, action.id))
							}),
							pendingAction ? /* @__PURE__ */ jsxs("div", {
								role: "alertdialog",
								"aria-modal": "false",
							...
							/* @__PURE__ */ jsxs("details", {
								...
								children: [/* @__PURE__ */ jsx("summary", { children: "开发者模式 · 原始事件投影" }), rawProjectionOpen ? /* @__PURE__ */ jsx("pre", { children: rawProjection }) : null]
							})
						] }) : null
					]
				})
...
//#endregion
export { DungeonPartyOverlay, OverlayErrorBoundary, apply, formatTime, inject, memberMeters, validationCheckCounts, validationFindingGroups };