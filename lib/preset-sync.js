...
import { registerDungeonSessionEventTypes, registerHostDungeonSessionEventTypes, } from './session-event-compat.js';
...
export async function apply(ctx) {
    if (!ctx.baseUrl)
        throw new Error('dungeon-party: host baseUrl is required for Session event compatibility');
